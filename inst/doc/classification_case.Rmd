...
```{r confusion_matrix multiclass, fig.width=6, fig.height=5, dpi=120}  
# a. Print
...
```{r scatter_plot print_metrics, fig.width=6, fig.height=5, dpi=120}
...
```{r scatter_plot.edit, fig.width=6, fig.height=5, dpi=120}
